...
| Предусловие| Открыта страница товара часы "Однострелочник"|
...
| Номер | 2 |
| --- | --- |
| Заголовок| Совершение заказа через форму “Оформление заказа” на странице оформления заказа |
| Предусловие| Открыта корзина с выбранным в ней товаром часы "Однострелочник" |
| Шаг| Ожидаемый результат|
...
| Номер | 4 |
| --- | --- |
| Заголовок| Получение скидки по промокоду |
| Предусловие| В корзине лежат часы “Однострелочник” |
| Шаг| Ожидаемый результат|
...
| Номер | 5 |
| --- | --- |
| Заголовок| Заказ часов с индивидуальным дизайном |
| Предусловие| Открыта главная страница сайта |
| Шаг| Ожидаемый результат|
...
| Предусловие| Открыта корзина, добавлен товар часы “Однострелочник” |
| Шаг| Ожидаемый результат|
...
| Номер | 7 |
| --- | --- |
| Заголовок| Сброс настроек подбора товара |
| Предусловие| Открыта страница “Наручные часы” |
| Шаг| Ожидаемый результат|
...
| Номер | 8 |
| --- | --- |
| Заголовок| Скачивание документов |
| Предусловие| Открыта страница “Документы” |
| Шаг| Ожидаемый результат|
...
| Номер | 9 |
| --- | --- |
| Заголовок| Изменение числа товаров в корзине |
| Предусловие| Открыта корзина, выбраны часы “Однострелочник” |
| Шаг| Ожидаемый результат|
...
| Номер | 10 |
| --- | --- |
| Заголовок| Заказ автомобильных кварцевых часов |
| Предусловие| Открыта главная страница сайта |
| Шаг| Ожидаемый результат|
